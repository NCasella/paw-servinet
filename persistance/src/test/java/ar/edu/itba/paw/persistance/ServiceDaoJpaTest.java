 ...
 public class ServiceDaoJpaTest {
    ...
    @Before
    public void setup(){
        em.createNativeQuery("INSERT INTO users (userid, username, password, name, surname, email, telephone,isprovider,isverified,profilepic) VALUES (1, 'username', 'password', 'name', 'surname', 'email', 'telephone',false,true,1)").executeUpdate();
