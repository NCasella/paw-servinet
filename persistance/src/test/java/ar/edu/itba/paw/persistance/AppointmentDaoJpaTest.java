package ar.edu.itba.paw.persistance;
 ...
 public class AppointmentDaoJpaTest {
     ...
     @Before
     public void setup() {
         em.createNativeQuery("insert into users(userid,username, name, surname, email, telephone, password, isprovider,isverified,profilepic) values (1,'solro', 'sol', 'rodri', 'solrodriguezgiana@gmail.com', '113452343', 'solro', true,true,3);").executeUpdate();
