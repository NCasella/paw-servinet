...
<head>
    ...
    <title><spring:message code="error.badrequest"/></title>
</head>
<body>
<div class="page">

    <img class="svg" src="${pageContext.request.contextPath}/resources/400.svg" alt="ERROR: Bad request">
    <h2 class="header-text"><spring:message code="error.badrequest"/></h2>
